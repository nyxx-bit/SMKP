            ...
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <form class="form-inline d-none d-sm-inline-block mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="GET" action="{{route('karyawan.search')}}">
                  ...
                  <div class="modal-body">
                    <div class="col-md-6">
                        <form method="POST" action="{{ route('karyawan.store')}}">
                            ...
                            <input type="text" class="border rounded-0 form-control" style="width: 440px;margin-bottom: 15px;" placeholder="Telepon" name="telp"/>
                            ...
                            <input type="text" class="border rounded-0 form-control" placeholder="Jabatan" style="margin-bottom: 15px;width: 440px;" name="nama_jabatan" />
                            <input type="text" class="border rounded-0 form-control" style="width: 440px;margin-bottom: 15px;" placeholder="Gaji Pokok" name="gaji_pokok" />
                            <input type="text" class="border rounded-0 form-control" style="width: 440px;margin-bottom: 15px;" placeholder="Tunjangan" name="tunjangan" />
                                    ...
                                    <div class="modal fade" id="edit<?=$data['karyawan_id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            <div class="col-md-6">
                                                <form method="POST" action="{{ route('karyawan.update', $data['karyawan_id'])}}">
                                                    @csrf
                                                    ...
                                                    <input type="text" class="border rounded-0 form-control" style="width: 440px;margin-bottom: 15px;" placeholder="Telepon" name="telp" value="<?=$data['telp']?>"/>
                                                    ...
                                                    <input type="text" class="border rounded-0 form-control" placeholder="Jabatan" style="margin-bottom: 15px;width: 440px;" name="nama_jabatan" value="<?=$data['nama_jabatan']?>"/>
                                                    <input type="text" class="border rounded-0 form-control" style="width: 440px;margin-bottom: 15px;" placeholder="Gaji Pokok" name="gaji_pokok" value="<?=$data['gaji_pokok']?>"/>
                                                    <input type="text" class="border rounded-0 form-control" style="width: 440px;margin-bottom: 15px;" placeholder="Tunjangan" name="tunjangan" value="<?=$data['tunjangan']?>"/>
                                    ...
                                    <div class="modal fade" id="deletemas<?=$data['karyawan_id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            <div class="col-md-6">
                                                <form method="POST" action="{{ route('karyawan.destroy', $data['karyawan_id'])}}">
                                                    @csrf
